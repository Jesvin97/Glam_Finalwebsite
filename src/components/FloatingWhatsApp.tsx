...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="whatsapp-float-btn fixed bottom-6 right-6 z-[99999] flex items-center justify-center w-[54px] h-[54px] sm:w-[60px] sm:h-[60px] bg-[#25D366] text-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.25)] hover:bg-[#22c35e] hover:shadow-[0_6px_20px_rgba(37,211,102,0.4)] transition-all duration-300 transform hover:scale-110 active:scale-95 cursor-pointer group"
    >
