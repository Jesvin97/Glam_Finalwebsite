  ...
  const fallbackTestimonials: Testimonial[] = [
    {
      ...
      text: "Glammore is hands down the best premium salon in Thiruvalla! The bridal makeup and luxury spa session was absolute perfection. Highly recommended!",
    },
    {
      name: "Rohan Mathew",
    ...
    },
    {
      ...
      role: "Regular Client",
      avatar: "/images/model.jpeg",
      text: "Step into pure luxury! Glammore's attention to detail, premium organic products, and highly skilled styling team completely transformed my hair styling routine.",
    },
    {
